#PBS -N  Pipeline_testing
#PBS -S /bin/bash
#PBS -l walltime=10:00:00
#PBS -l nodes=1:ppn=1
#PBS -l mem=96gb
#PBS -o /scratch/akoppayi/PipeTest/Pipe2test/logfiles/O_Pipe.out
#PBS -e /scratch/akoppayi/PipeTest/Pipe2test/logfiles/E_Pipe.err
#PBS -d /scratch/akoppayi/PipeTest/Pipe2test



logfile="/scratch/akoppayi/PipeTest/Pipe2test/logfiles/LVC_Pipe.txt"
mkdir Completed
path="/scratch/akoppayi/PipeTest/Pipe2test/Completed"
...
/apps/software/gcc-6.2.0/bwa/0.7.15/bwa mem -M -t 7 -p /gpfs/data/godley-lab/WES_analysis/reference_human_38/Homo_sapiens.GRCh38.dna.toplevel.fa.gz $output3a > ${output3a%_3a_forBWA.fastq}"_3b_bwa_mem.sam" ;
  if test -f "$output3b"; then
...
java -jar /apps/software/java-jdk-1.8.0_92/gatk/3.7/GenomeAnalysisTK.jar -T BaseRecalibrator -R /gpfs/data/godley-lab/WES_analysis/reference_human_38/Homo_sapiens.GRCh38.dna.toplevel.fa -I $output4 -knownSites /gpfs/data/godley-lab/WES_analysis/dbsnp/All_20170710_sort.vcf -o ${output4%_step4.bam}"_step5a_BaseRecalibrator.table" -U ALLOW_SEQ_DICT_INCOMPATIBILITY; 
...
java -jar /apps/software/java-jdk-1.8.0_92/gatk/3.7/GenomeAnalysisTK.jar -T PrintReads -R /gpfs/data/godley-lab/WES_analysis/reference_human_38/Homo_sapiens.GRCh38.dna.toplevel.fa -I $output4 -BQSR ${output4%_step4.bam}"_step5a_BaseRecalibrator.table" -o ${output4%_step4.bam}"_step5b.bam" ;
...
java -jar /apps/software/java-jdk-1.8.0_92/gatk/3.7/GenomeAnalysisTK.jar -T HaplotypeCaller -R /gpfs/data/godley-lab/WES_analysis/reference_human_38/Homo_sapiens.GRCh38.dna.toplevel.fa -I $output5b --genotyping_mode DISCOVERY -o ${output5b%_step5b.bam}".vcf"; 
...
/gpfs/data/godley-lab/WES_analysis/annovar/table_annovar.pl $output6 /gpfs/data/godley-lab/WES_analysis/annovar/humandb/ -buildver hg38 -out ${output6%.vcf} -arg '-splicing 15',,,,,,,, -remove -protocol refGene,cytoBand,exac03,gnomad_exome,gnomad_genome,kaviar_20150923,clinvar_20170905,avsnp147,dbnsfp30a -operation g,r,f,f,f,f,f,f,f -nastring . -vcfinput ; 
